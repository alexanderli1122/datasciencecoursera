...
hist(subsetdata[,3],xlab = "Global Active Power (kilowatts)",ylab="Frequency",main="Global Active Power (kilowatts)",col = "red")->plot1
plot(subsetdata[,3]~subsetdata[,2],type="l",lwd=0.5, ylab="Global Active Power (kilowatts)",xlab="")->plot2